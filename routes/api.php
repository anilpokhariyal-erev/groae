...
Route::get('freezone/{uuid}/visa_package/', [FreezoneController::class, 'getVisaPackageAttributes']);
Route::post('package/save-activities/', [PackageController::class, 'savePackageActivities'])->middleware(['auth:sanctum']);

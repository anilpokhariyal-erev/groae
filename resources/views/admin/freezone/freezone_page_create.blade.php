<x-admin-layout>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form method="post" action="{{ route('freezone-page.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <textarea name="content" id="ckeditor_description" class="form-control">{{ old('content') }}</textarea>

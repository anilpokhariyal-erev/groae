                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <textarea name="benefits" class="form-control">{{ old('benefits', $freezone->benefits) }}</textarea>
                ...
                <div class="border-1-solid-grey p-3 mt-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative form-group">
                                <label>Additional Information</label>
                                <textarea name="rule_regulation_info" class="form-control">{{ $freezone->rule_regulation_info ?? ''}}</textarea>

        ...
        <div class="card-body">
            <div class="ba_flex justify-between">
                <div class="ba_flex align_items_center">
                    <h5 class="card-heading">Edit Freezone User</h5>
                </div>
            ...
            &nbsp;
            <form method="post" action="{{ route('freezone-users.update', $user->uuid) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-group">
                                <input name="password" id="password" value="{{old('password')}}" placeholder="********" autocomplete="new-password" type="password" class="form-control" oninput="showCopy('password')">
                        ...
                        <div class="position-relative form-group">
                            ...
                            <select name="freezones" class="custom-select">
                                ...
                                @foreach($freezones as $freezone)
                                    <option value="{{$freezone->id}}" @if($user->freezone_id == $freezone->id) selected @endif>{{ucfirst($freezone->name)}}</option>
                                @endforeach
                            </select>

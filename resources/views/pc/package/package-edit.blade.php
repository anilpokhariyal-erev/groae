                ...
                <div class="row">
                            ...
                            <select name="freezone" class="custom-select">
                                ...
                                @if($freezone)
                                    @foreach($freezone as $freezone_val)
                                        <option @if(old('freezone',$package->freezone_id) == $freezone_val->id) selected='selected' @endif value="{{$freezone_val->id}}">{{$freezone_val->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="name" id="name" value="{{old('name',$package->name)}}" type="text" class="form-control">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="price" id="price" value="{{old('price',$package->phl_fee)}}" type="number" class="form-control" min="0">

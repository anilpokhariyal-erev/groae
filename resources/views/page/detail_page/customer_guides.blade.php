                ...
                <div style="position: relative; z-index:0">
                    ...
                    <div class="detailContent">
                        <div class="detailHeading">
                            <h3>Customer Guides</h3>
                        </div>
                        <div class="detailContntInnr">
                            <p>Welcome to Dubai Internet City (DIC), the dynamic epicenter of technological innovation in the heart of the Middle East. As the region's premier tech-focused free zone, DIC offers a thriving ecosystem for businesses, entrepreneurs, and tech enthusiasts alike. Nestled amidst the iconic Dubai skyline, DIC provides state-of-the-art infrastructure, strategic networking opportunities, and a supportive regulatory environment tailored for the growth of technology-driven enterprises. Whether you're a startup aiming to make your mark or an established company seeking to expand in a vibrant market, DIC is your gateway to success. Join the ranks of global tech giants and discover a world of possibilities at Dubai Internet City – where innovation knows no bounds.</p>
                        </div>
                    </div>

                    <div>
                        <div class="imageContainer">
                            <img src="{{ secure_asset('images/Customer_Guides.png') }}" alt="">
                        </div>
                    </div>

    ...
    <table width="100%" style="max-width:600px; margin:20px auto; padding:20px; background-color:#ffffff; border-spacing:0; border:0; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.1);">
        <tr>
            <td style="font-size:16px; color:#304A6F; line-height:1.8; padding:20px;">
                ...
                Thank you for joining <strong>GroAE</strong>! We’re thrilled to have you with us.
                To complete your registration, please verify your email address by clicking the button below:
            </td>
        </tr>
        <tr>
            <td style="text-align:center; padding:20px;">
                <a href="{{ $verificationCode }}" style="background-color:#304A6F; color:#ffffff; padding:15px 30px; font-size:16px; font-weight:bold; text-decoration:none; border-radius:5px; display:inline-block;">Verify My Email</a>
            </td>
        </tr>
        <tr>
            <td style="font-size:16px; color:#304A6F; line-height:1.8; padding:20px;">
                If you didn’t create an account, no action is required, and you can safely ignore this email.<br><br>
                Need help? Feel free to contact us anytime.<br><br>
                Regards,<br>
